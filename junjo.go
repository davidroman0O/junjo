...
// `Junjo` is your main interface with it's systems which provide an API to facilitate your interaction with it
...
// New `Junjo` Api
func New(implt types.StorageInterface) *Junjo {
	return &Junjo{
...
// Create a new `Topic`
func (j *Junjo) CreateTopic(name string, cfgs ...types.TopicConfig) (*types.Topic, error) {
	return j.
...
// Create a new `Owner`
func (j *Junjo) CreateOwner(name string, cfgs ...types.OwnerConfig) (*types.Owner, error) {
	return j.
		storageImplementation.
...
func (j *Junjo) CreateTaskDefinition(name string, ownerID types.OwnerID, cfgs ...types.TaskDefinitionConfig) (*types.TaskDefinition, error) {
	return j.
		storageImplementation.
...
func (j *Junjo) CreateDagTaskUnits() *types.WorkUnitDag {
...
func (j *Junjo) CreateTask(cfgs ...types.TaskConfig) (*types.Task, error) {
	return j.
		storageImplementation.
		CreateTask(cfgs...)
}
...
func (j *Junjo) CreateJob(cfgs ...types.JobConfig) (*types.Job, error) {
	return j.
		storageImplementation.
		CreateJob(cfgs...)
}
...
func (j *Junjo) CreateTaskUnits(units []*types.TaskUnit) ([]types.TaskUnitID, error) {
	return j.
		storageImplementation.
...
func (j *Junjo) AssignJob(topicID types.TopicID, jobID types.JobID) error {
...
func (j *Junjo) AssignTask(jobID types.JobID, taskID types.TaskID) error {
...
func (j *Junjo) AssignTaskUnits(taskID types.TaskID, ids []types.TaskUnitID) error {
